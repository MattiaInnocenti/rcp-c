...
int main(int argc, char const *argv[])
{
    ...
    /*-----------------------------------------------------------------------------------------------------------
    TEST!!! - Pc Matti i7-10510
    Scopriamo che con un file da 80000 byte, il client impiega per la sua esecuzione:
     - 0.051145 microsec --> se legge 1 byte alla volta e li scrive allo stesso modo
    ...
    TEST!!! - Pc Andre i7-7700HQ
    - 0.205159 microsec --> se legge 1 byte alla volta e li scrive allo stesso modo
    - 0.001399 --> se legge 256 byte alla volta e li scrive allo stesso modo
    - 0.000841 --> se legge 1024 byte alla volta e li scrive allo stesso modo
    - 0.000617 --> se legge 2048 byte alla volta e li scrive allo stesso modo
    - 0.000565 --> se legge 4096 byte alla volta e li scrive allo stesso modo
    - 0.000528 --> se legge 8192 byte alla volta e li scrive allo stesso modo
    - 0.000528 --> se legge 16384 byte alla volta e li scrive allo stesso modo
